...
export const componentAPI = {
  ...
  getComponents: (filters = {}) =>
    api.get('/component-library/components', { params: filters }),
  getComponent: componentId =>
    api.get(`/component-library/components/${componentId}`),
  getComponentsByType: type =>
    api.get(`/component-library/components/type/${type}`),
  getComponentsByCategory: category =>
    api.get(`/component-library/components/category/${category}`),
  createComponent: componentData =>
    api.post('/component-library/components', componentData),
  getPopularComponents: (limit = 10) =>
    api.get('/component-library/popular', { params: { limit } }),

  // Component instances
  getCardComponents: cardId =>
    api.get(`/component-library/instances/card/${cardId}`),
  ...
  deleteComponentInstance: instanceId =>
    api.delete(`/component-library/instances/${instanceId}`),

  // Analytics
  getComponentAnalytics: componentId =>
    api.get(`/component-library/analytics/${componentId}`),
  ...
  publishComponentToMarketplace: (componentId, marketplaceData) =>
    api.post('/component-library/marketplace/publish', {
      componentId,
      marketplaceData,
    }),
