...
export function AnalyticsDashboard({ userId, cardId }) {
  ...
  // Fetch data
  const { metrics: cardMetrics, loading: loadingCard } = useCardMetrics(
    cardId,
    timeRange
  )
  const { metrics: userMetrics, loading: loadingUser } = useUserMetrics(
    userId,
    timeRange
  )
  ...
  const isLoading =
    loadingCard || loadingUser || loadingHeatmap || loadingTrending
                    ...
                    <div className="metric-items">
                      <div className="metric-item">
                        ...
                        <span className="metric-value">
                          {cardMetrics?.events?.view || 0}
                        </span>
                      </div>
                      <div className="metric-item">
                        <span className="metric-label">Edits</span>
                        <span className="metric-value">
                          {cardMetrics?.events?.edit || 0}
                        </span>
                      </div>
                      <div className="metric-item">
                        <span className="metric-label">Shares</span>
                        <span className="metric-value">
                          {cardMetrics?.events?.share || 0}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="metric-card">
                    ...
                    <div className="metric-items">
                      <div className="metric-item">
                        ...
                        <span className="metric-value">
                          {userMetrics?.totalEvents || 0}
                        </span>
                      </div>
                      <div className="metric-item">
                        <span className="metric-label">Cards Edited</span>
                        <span className="metric-value">
                          {userMetrics?.cardsEdited || 0}
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="metric-card">
                      ...
                      <div className="metric-items">
                        <div className="metric-item">
                          ...
                          <span className="metric-value">
                            {Math.round(
                              performance.performance?.avg_render_time || 0
                            )}
                            ms
                          </span>
                        </div>
                        <div className="metric-item">
                          ...
                          <span className="metric-value">
                            {Math.round(
                              performance.performance?.p95_render_time || 0
                            )}
                            ms
                          </span>
                        </div>
                ...
                <div className="engagement-content">
                  <div className="engagement-chart">
                    ...
                    <div className="event-bars">
                      {cardMetrics?.events &&
                        Object.entries(cardMetrics.events).map(
                          ([type, count]) => (
                  ...
                  <div className="user-activity">
                    ...
                    <div className="activity-list">
                      {userMetrics?.eventSummary &&
                        Object.entries(userMetrics.eventSummary).map(
                          ([type, count]) => (
                      ...
                      <div className="perf-metrics">
                        <div className="perf-metric">
                          ...
                          <span className="perf-value">
                            {Math.round(
                              cardMetrics.performance.avg_render_time
                            )}
                            ms
                          </span>
                        </div>
                        <div className="perf-metric">
                          ...
                          <span className="perf-value">
                            {Math.round(
                              cardMetrics.performance.max_render_time
                            )}
                            ms
                          </span>
                        </div>
                        <div className="perf-metric">
                          ...
                          <span className="perf-value">
                            {Math.round(
                              cardMetrics.performance.min_render_time
                            )}
                            ms
                          </span>
                        </div>
                      ...
                      <div key={idx} className="trending-item">
                        ...
                        <div className="trending-info">
                          ...
                          <div className="trending-stats">
                            ...
                            <span className="stat-badge edits">
                              ✏️ {card.edits}
                            </span>
                            <span className="stat-badge shares">
                              📤 {card.shares}
                            </span>
